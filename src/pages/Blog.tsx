...
export const Blog = () => {
  ...
  const { posts, stats } = getBlogData(language);
  ...
  const t =
    language === "en"
      ? {
          eyebrow: "Blog",
          title: "Kyshik plans and notes",
          desc: "We write about privacy, ethical AI, safe animal counting, and how to make helping a steady habit.",
          featured: "Featured article",
          readArticle: "Read article",
          read: "Read",
          principles: "Principles we keep",
        }
      : {
          eyebrow: "Блог",
          title: "Будущие планы и заметки Kyshik",
          desc: "Пишем о приватности, этичном ИИ, безопасном учете и том, как сделать помощь животным регулярной привычкой.",
          featured: "Главная статья",
          readArticle: "Читать статью",
          read: "Читать",
          principles: "Принципы, которые сохраняем",
        };
